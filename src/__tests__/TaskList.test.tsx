...
describe('TaskList', () => {
  ...
  describe("error handling", () => {
    it('handles errors when createTask fails', async () => {
        ...
        mockedTaskApi.fetchTasks.mockRejectedValue([]);
        mockedTaskApi.createTask.mockRejectedValue(new Error('fail'))
  ...
  describe("Edge Case 1", () => {
    it('does not add task when title is only whitespace', async () => {
      const user = userEvent.setup();
  ...
  describe('Edge Case 2', () => {
    it('Accepts long task titles', async () => {
      const longTaskTitle = 'A'.repeat(500);
